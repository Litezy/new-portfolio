    ...
    <Layout>
      <div id="page-about">
        ...
        >
          ...
          >
            <div className="anim-child font-mono text-[9px] tracking-[0.2em] text-aqua uppercase mb-4">
              THE ARCHITECT
            </div>
            ...
            <div className="anim-child flex flex-wrap gap-2 mb-8 md:mb-10">
              {arsenalChips.map((chip) => (
                <div
                  key={chip}
                  className="font-mono text-[10px] tracking-[0.08em] uppercase text-[#888] border border-[#2e2e2e] px-3.5 py-2 flex items-center gap-1.5 cursor-default transition-all duration-200 hover:border-aqua hover:text-text"
                >
