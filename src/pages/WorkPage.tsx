...
import { FILTER_TABS, type FilterValue } from "../utils/utils";
...
export default function WorkPage() {
  ...
  const setFilter = (value: FilterValue) => {
    setSearchParams(value ? { filter: value } : undefined);
  };
  ...
  return (
    <Layout>
      <div id="page-work" className="">
        ...
        <div
          ref={headerRef}
          className="pb-10 border-b border-[#1c1c1c] relative overflow-hidden"
        >
          {/* Watermark counter */}
          <div
            aria-hidden
          ...
          <p className="anim-child text-[14px] text-[#4a4a4a] max-w-[520px] leading-relaxed mb-8">
            Smart contract architectures, scalable backend systems, and
            high-performance frontend engineering — spanning DeFi protocols,
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <span className="font-mono text-[8px] tracking-[0.18em] uppercase text-[#333]">
                ...
                <span
                  className="font-bold"
                  style={{
                    color: activeFilter === "web3" ? "#ff2d78" : "#38bdf8",
                  }}
                >
        ...
        {visibleProjects.length > 0 ? (
          <div
            ...
            className="grid gap-6 pt-10 sm:grid-cols-2 lg:grid-cols-3"
          >
        ...
        <div className="border-t border-[#1c1c1c] px-7 py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
            ...
            <p className="font-mono text-[9px] tracking-[0.14em] uppercase text-[#333]">
              Available for new engagements — DeFi, infrastructure, and
              full-stack Web3.
            </p>
          </div>
          <button
